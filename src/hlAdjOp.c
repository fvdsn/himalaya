...
void hl_invert_16b(hlTile *t, const uint32_t chan){
	int32_t i = chan* HL_TILEWIDTH*HL_TILEWIDTH;
	int32_t j = chan - 1;
	uint16_t * data = HL_DATA_16B(t);
	while((i-=chan)>= 0){
		j = chan - 1;
		while (j--){
			data[i+j] = 65355 - data[i+j];
		}
	}
}
...
void hlAdjOpInvert(hlTile *t, hlParam *p){
	...
	switch(hlCSGetBpc(hlParamGetCS(p))){
		...
		case HL_16B:{hl_invert_16b(t,chan);break;}
...
uint16_t hl_add_16b(uint16_t a, int b){
	int c = a+b;
	if(c > 65355)
		return 65355;
	else if (c < 0 )
...
uint16_t hl_mul_16b(uint16_t a, float b){
	long int c = a * b;
	if (c > 65355)
		return 65355;
	else if (c < 0)
...
uint16_t hl_div_16b(uint16_t a, float b){
	long int c;
	if (b == 0.0)
		return 65355;
	else if ( (c = a / b) > 65355)
		...
		return 65355;
	else return (uint16_t)c;
}
uint16_t hl_more_16b(uint16_t a, uint16_t b){
	if (a > b){
		return a;
	}else{
		return b;
...
uint16_t hl_less_16b(uint16_t a, uint16_t b){
	if (a < b){
		return a;
	}else{
		return b;
...
uint16_t hl_pow_16b(uint16_t a, float b){
	float fa = a / 65355.0;
	fa = pow(fa,b);
	return (uint16_t)fa*65355.0;
}
void hl_math_16b(hlTile *t, unsigned int id, const uint32_t chan, const float * f){
	int32_t i = chan*HL_TILEWIDTH*HL_TILEWIDTH;
	uint16_t * data = HL_DATA_16B(t);
	int  fact[5];
	uint16_t fact16[5];
	...
	fact16[0] =(uint16_t) f[0]; 
	fact16[1] =(uint16_t) f[1];
	fact16[2] =(uint16_t) f[2];
	fact16[3] =(uint16_t) f[3];
	fact16[4] =(uint16_t) f[4];

	while((i-=chan)>= 0){
		switch(id){
		case HL_ADJ_ADD:{
			switch(chan){
				case 5 : data[i+3] = hl_add_16b(data[i+3], fact[3]);
				case 4 : data[i+2] = hl_add_16b(data[i+3], fact[2]);
				case 3 : data[i+1] = hl_add_16b(data[i+1], fact[1]);
				case 2 : data[i]   = hl_add_16b(data[i],   fact[0]);
				case 1 : { 
					data[i+ chan - 1] = 
						hl_add_16b(data[i+chan-1], fact[4]);
					break;
				}
			}
			break;
		...
		case HL_ADJ_MUL:{
			switch(chan){
				case 5 : data[i+3] = hl_mul_16b(data[i+3], f[3]);
				case 4 : data[i+2] = hl_mul_16b(data[i+2], f[2]);
				case 3 : data[i+1] = hl_mul_16b(data[i+1], f[1]);
				case 2 : data[i]   = hl_mul_16b(data[i], f[0]);
				case 1 : { 
					data[i+ chan - 1] = 
						hl_mul_16b(data[i+chan-1],f[4]);
					break;
				}
			}
			break;
		...
		case HL_ADJ_DIV:{
			switch(chan){
				case 5 : data[i+3] = hl_div_16b(data[i+3], f[3]);
				case 4 : data[i+2] = hl_div_16b(data[i+2], f[2]);
				case 3 : data[i+1] = hl_div_16b(data[i+1], f[1]);
				case 2 : data[i]   = hl_div_16b(data[i], f[0]);
				case 1 : { 
					data[i+ chan - 1] = 
						hl_div_16b(data[i+chan-1],f[4]);
					break;
				}
			}
			break;
		...
		case HL_ADJ_MOD:{
			switch(chan){ /*doesn't work*/
				case 5 : data[i+3]%= fact[3];
				case 4 : data[i+2]%= fact[2];
				case 3 : data[i+1]%= fact[1];
				case 2 : data[i]  %= fact[0];
				case 1 : { 
					data[i+ chan - 1] %= fact[4];
					break;
				}
		...
		case HL_ADJ_LESS:{
			switch(chan){
				case 5 : data[i+3] = hl_less_16b(data[i+3], fact16[3]);
				case 4 : data[i+2] = hl_less_16b(data[i+3], fact16[2]);
				case 3 : data[i+1] = hl_less_16b(data[i+1], fact16[1]);
				case 2 : data[i]   = hl_less_16b(data[i],   fact16[0]);
				case 1 : { 
					data[i+ chan - 1] = 
						hl_less_16b(data[i+chan-1], fact16[4]);
					break;
				}
			}
			break;
		...
		case HL_ADJ_MORE:{
			switch(chan){
				case 5 : data[i+3] = hl_more_16b(data[i+3], fact16[3]);
				case 4 : data[i+2] = hl_more_16b(data[i+3], fact16[2]);
				case 3 : data[i+1] = hl_more_16b(data[i+1], fact16[1]);
				case 2 : data[i]   = hl_more_16b(data[i],   fact16[0]);
				case 1 : { 
					data[i+ chan - 1] = 
						hl_more_16b(data[i+chan-1], fact16[4]);
					break;
				}
			}
			break;
		...
		case HL_ADJ_POW:{
			switch(chan){
				case 5 : data[i+3] = hl_pow_16b(data[i+3], f[3]);
				case 4 : data[i+2] = hl_pow_16b(data[i+2], f[2]);
				case 3 : data[i+1] = hl_pow_16b(data[i+1], f[1]);
				case 2 : data[i]   = hl_pow_16b(data[i], f[0]);
				case 1 : { 
					data[i+ chan - 1] = 
						hl_pow_16b(data[i+chan-1],f[4]);
					break;
				}
			}
			break;
...
void hlAdjOpMath(hlTile *t, hlParam *p){
	...
	switch(hlCSGetBpc(hlParamGetCS(p))){
		...
		case HL_16B:{ hl_math_16b(t,id,chan,num);break;}
...
void hl_chanmix_16b(hlTile *t,unsigned int chan, const float *n){
	int32_t i = chan*HL_TILEWIDTH*HL_TILEWIDTH;
	uint16_t *d = HL_DATA_16B(t);
	while((i-=chan)>=0){
		switch (chan){
			case 5:
			d[i]   = n[0]*d[i]  +n[1]*d[i+1]  +n[2]*d[i+2]  +n[3]*d[i+3]  +n[4]*d[i+4];
...
void hlAdjOpChanmix(hlTile *t, hlParam *p){
	...
	switch(hlCSGetBpc(hlParamGetCS(p))){
		...
		case HL_16B:{ hl_chanmix_16b(t,chan,num);break;}
...
void hlAdjOpLevels(hlTile *t, hlParam *p){
	...
	switch(hlCSGetBpc(p->cs)){
		...
		case HL_16B:{ hl_levels_16b(t,chan,p->num);break;}
